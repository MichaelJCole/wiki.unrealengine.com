...
<body class="mediawiki ltr sitedir-ltr ns--1 ns-special mw-special-Prefixindex page-Special_PrefixIndex_Talk_Interfaces_in_C_skins_vector_js skin-vector action-view vector-animateLayout">
		...
		<div id="content" class="mw-body" role="main">
			...
			<div id="bodyContent">
				...
				<td class='mw-input'><input name="prefix" size="30" value="Interfaces in C/skins.vector.js" id="nsfrom" /></td>
			</tr>
			<tr>
...
<option value="15">Category talk</option>
				...
				Retrieved from "<a href="https://wiki.unrealengine.com/Special:PrefixIndex/Talk:Interfaces_in_C/skins.vector.js">https://wiki.unrealengine.com/Special:PrefixIndex/Talk:Interfaces_in_C/skins.vector.js</a>"				</div>
	...
	<ul>
<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Special%3APrefixIndex%2FTalk%3AInterfaces+in+C%2Fskins.vector.js&amp;type=signup">Create account</a></li><li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Special%3APrefixIndex%2FTalk%3AInterfaces+in+C%2Fskins.vector.js" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>	</ul>
</div>
				<div id="left-navigation">
					<div id="p-namespaces" role="navigation" class="vectorTabs" aria-labelledby="p-namespaces-label">
	<h3 id="p-namespaces-label">Namespaces</h3>
	<ul>
					<li  id="ca-nstab-special" class="selected"><span><a href="/Special:PrefixIndex/Talk:Interfaces_in_C/skins.vector.js"  title="This is a special page, you cannot edit the page itself">Special page</a></span></li>
			</ul>
</div>
...
<div class="portal" role="navigation" id='p-tb' aria-labelledby='p-tb-label'>
	...
	<div class="body">
		<ul>
			...
			<li id="t-print"><a href="/index.php?title=Special:PrefixIndex/Talk:Interfaces_in_C/skins.vector.js&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
		</ul>
	</div>
</div>
			</div>
