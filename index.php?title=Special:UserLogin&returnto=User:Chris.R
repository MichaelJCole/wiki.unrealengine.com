...
<head>
<meta charset="UTF-8" /><title>Log in - Epic Wiki</title>
...
<link rel="stylesheet" href="https://wiki.unrealengine.com/load.php?debug=false&amp;lang=en&amp;modules=mediawiki.legacy.commonPrint%2Cshared%7Cmediawiki.special.userlogin%7Cmediawiki.ui%7Cskins.vector&amp;only=styles&amp;skin=epic&amp;*" />
...
<body class="mediawiki ltr sitedir-ltr ns--1 ns-special mw-special-UserLogin page-Special_UserLogin skin-epic action-view vector-animateLayout">
...
<div class="portal" role="navigation" id='p-tb' aria-labelledby='p-tb-label'>
	...
	<div class="body">
		<ul>
			...
			<li id="t-print"><a href="/index.php?title=Special:UserLogin&amp;returnto=User%3AChris.R&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
		</ul>
	</div>
</div>
						</div>
	...
	<ul>
					<li  id="ca-nstab-special" class="selected"><span><a href="/index.php?title=Special:UserLogin&amp;returnto=User%3AChris.R"  title="This is a special page, you cannot edit the page itself">Special page</a></span></li>
			</ul>
</div>
...
<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=User%3AChris.R&amp;type=signup">Create account</a></li><li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=User%3AChris.R" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>	</ul>
		...
		<form name="userlogin" class="mw-ui-vform" method="post" action="/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=login&amp;returnto=User:Chris.R">
			...
			<div>
				...
				<input class="loginText" id="wpName1" tabindex="1" size="20" autofocus="" placeholder="Enter your email address" name="wpName" />			</div>
			...
			<div id="mw-userlogin-help">
				<a href="/Help:Logging_in" title="Help:Logging in">Help with logging in</a>			</div>
												<div id="mw-createaccount-cta">
						<h3 id="mw-userloginlink">Don&#039;t have an account?<a href="/index.php?title=Special:UserLogin&amp;type=signup&amp;returnto=User:Chris.R" id="mw-createaccount-join" tabindex="7"  class="mw-ui-button mw-ui-constructive">Join Epic Wiki</a></h3>
					</div>
													<input type="hidden" name="wpLoginToken" value="f2f9798d2b1c9368167ca5404aac9166" />					</form>
	</div>
</div>
</div>												<div class="printfooter">
				Retrieved from "<a href="https://wiki.unrealengine.com/Special:UserLogin">https://wiki.unrealengine.com/Special:UserLogin</a>"				</div>
...
<!-- Served in 0.091 secs. -->		<img src="https://tracking.unrealengine.com/track.png" width="1" height="1">
