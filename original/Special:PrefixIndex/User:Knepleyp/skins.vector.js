...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"Special","wgCanonicalSpecialPageName":"Prefixindex","wgNamespaceNumber":-1,"wgPageName":"Special:PrefixIndex/User:Knepleyp/skins.vector.js","wgTitle":"PrefixIndex/User:Knepleyp/skins.vector.js","wgCurRevisionId":0,"wgRevisionId":0,"wgArticleId":0,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"view","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Special:PrefixIndex/User:Knepleyp/skins.vector.js","wgIsProbablyEditable":false,"wgWikiEditorEnabledModules":{"toolbar":true,"dialogs":true,"hidesig":true,"templateEditor":false,"templates":false,"preview":true,"previewDialog":false,"publish":true,"toc":false}});
...
<body class="mediawiki ltr sitedir-ltr ns--1 ns-special mw-special-Prefixindex page-Special_PrefixIndex_User_Knepleyp_skins_vector_js skin-vector action-view vector-animateLayout">
		...
		<div id="content" class="mw-body" role="main">
			...
			<div id="bodyContent">
				...
				<td class='mw-input'><input name="prefix" size="30" value="Knepleyp/skins.vector.js" id="nsfrom" /></td>
			</tr>
			<tr>
...
<option value="15">Category talk</option>
				...
				Retrieved from "<a href="https://wiki.unrealengine.com/Special:PrefixIndex/User:Knepleyp/skins.vector.js">https://wiki.unrealengine.com/Special:PrefixIndex/User:Knepleyp/skins.vector.js</a>"				</div>
	...
	<ul>
<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Special%3APrefixIndex%2FUser%3AKnepleyp%2Fskins.vector.js&amp;type=signup">Create account</a></li><li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Special%3APrefixIndex%2FUser%3AKnepleyp%2Fskins.vector.js" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>	</ul>
</div>
				<div id="left-navigation">
					<div id="p-namespaces" role="navigation" class="vectorTabs" aria-labelledby="p-namespaces-label">
	<h3 id="p-namespaces-label">Namespaces</h3>
	<ul>
					<li  id="ca-nstab-special" class="selected"><span><a href="/Special:PrefixIndex/User:Knepleyp/skins.vector.js"  title="This is a special page, you cannot edit the page itself">Special page</a></span></li>
			</ul>
</div>
...
<div class="portal" role="navigation" id='p-tb' aria-labelledby='p-tb-label'>
	...
	<div class="body">
		<ul>
			...
			<li id="t-print"><a href="/index.php?title=Special:PrefixIndex/User:Knepleyp/skins.vector.js&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
		</ul>
	</div>
</div>
			</div>
